...
สังเกตว่าจะยังไม่มีกราฟใดๆ ปรากฏ ท่านจำเป็นต้องใช้ function `geom` เพื่อทำการสร้างภาพนั้นขึ้น
...
สังเกตว่าท่านสามารถปรับค่าจำพวก สี ลักษณะเส้นต่างๆ ได้ โดย parameter นั้น ต้องอยู่นอก `aes` มิเช่นนั้น function จะพยายามไปดึงข้อมูลจากกราฟมา
