...
จากกราฟ เส้นประคือเส้นของ $H_{0}$ หมายถึงการแสดงออกของยีนทั้งหมดสามารถหาได้โดยใช้ค่าเฉลี่ยโดยรวมของทั้งสองกลุ่ม $\text{Intensity} = \theta + \epsilon$ และ เส้นทึบคือเส้นของ $H_{a}$ หมายคือเส้นสมการถดถอยที่ลากผ่านค่าเฉลี่ยของแต่ละกลุ่ม $\text{Intensity }= \theta + \theta_{1}*\text{Group} + \epsilon$ ซึ่งทั้งหมดนี้ ก็คือเส้นสมการถดถอยเชิงเส้นตามปกติโดยทั่วไปนั่นเอง โดย limma ซึ่งความแตกต่างตามสมมติฐานนั้น จะถูกทดสอบ โดย $t$-test ($F$-test ถ้ามากกว่าสองกลุ่ม)
