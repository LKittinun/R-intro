...
ไฟล์แรกที่อ่านเข้ามาคือ `GSE63514_norm.csv` ซึ่งเป็นไฟล์ microarray expression ของชิ้นเนื้อปากมดลูก ประกอบด้วย ตัวอย่าง `Normal` , `CIN1` , `CIN2` , `CIN3` , `Cancer` ในที่นี้เราจะทำการวิเคราะห์ 20,000 gene แรก
...
หลังจากนั้นเราจะทำการพล็อต intensity ในแต่ละ gene
