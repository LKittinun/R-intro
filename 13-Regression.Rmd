...
-   **Likelihood** คือ ค่าของตวามเป็นไปได้ที่จะเกิดเหตุการณ์นั้นๆ
    ...
    $$โดย $y_{i}$ คือ ค่าของความเป็นไปได้ของการเกิดเหตุการณ์ตาม [Binomial distribution](#binom-dist) ซึ่งในที่นี่คือ `group` = 0 และ `group` = 1 ซึ่งการคำนวณนั้นจะนิยมใช้ค่า log มากกว่า เพิ่มความสะดวก
