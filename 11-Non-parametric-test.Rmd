...
$$
p = \frac{{K \choose k}{N-K \choose n-k}}{{N \choose n}} = \frac{{A+B \choose A}{C+D \choose C}}{{n \choose A+C}} = \frac{{A+B \choose B}{C+D \choose D}}{{n \choose B+D}}
$$

พิจารณาสูตร จุดประสงค์คือ การคำนวณความน่าจะเป็นของการหยิบสุ่มแบบไม่คืนให้ได้ตาม สถานการณ์ต้องการนั่นเอง
...
## or
phyper(lung_ob[1]-1,alive_dead[1], 
       alive_dead[2], male_female[1],lower.tail=FALSE)
```

**Note:** การใช้ `lung_ob[1] - 1` นั้นมีที่มาจากว่า เมื่อใช้ `lower.tail = FALSE` จะคำนวณโอกาสที่ ได้ $P[X > x]$ ซึ่งเราต้องการ $P[X \geq x]$ จึงต้องลบสถานการณ์ที่ต้องการออกด้วย
