...
คือการทดสอบว่าข้อมูลนั้นมีความสัมพันธ์หรือไม่ โดยการเทียบกับความสัมพันธ์แบบสุ่ม การทดสอบนี้จะมีความแม่นยำกว่า Chi-square เนื่องจากเป็นการคำนวณความน่าจะเป็นโดยตรง เมื่อพิจารณาตาราง $2 \times 2$ ในหลักของการหยิบสุ่ม จะตารางดังนี้

| Group/Success | Con1  | Con2      | Total |
|---------------|-------|-----------|-------|
| **Group 1**   | $k$   | $n-k$     | $n$   |
| **Group 2**   | $K-k$ | $N-K-n-k$ | $N-n$ |
| **Total**     | $K$   | $N-K$     | $N$   |

ซึ่งความน่าจะเป็นที่จะหยิบสุ่มได้สถานการณ์ที่ต้องการจำนวน $k$ ครั้ง คือ

$$
p_{k} = \frac{{K \choose k}{N-K \choose n-k}}{{N \choose n}} = \frac{{A+B \choose A}{C+D \choose C}}{{n \choose A+C}} = \frac{{A+B \choose B}{C+D \choose D}}{{n \choose B+D}}
$$
