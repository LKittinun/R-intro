...
```{r norm_dist, message = FALSE, echo = FALSE, warning = FALSE, out.width= "70%", fig.align="center"}
set.seed(123)
x <- seq(-5,5,0.01)
...
```{r z_dist, echo = FALSE, warning = FALSE, out.width= "70%", fig.align="center"}
...
คือ การกระจายตัวของ**ความต่างของค่าเฉลี่ยระหว่างกลุ่มตัวอย่าง**ที่สุ่มจากประชากร ใช้ใน [t-test](#sec-t-test)
...
```{r t_distribution, warning = FALSE, out.width= "70%", fig.align="center"}
...
หมายเหตุ $t$-score บางครั้งเป็นคำศัพท์เฉพาะทาง
...
```{r unif_distribution, warning = FALSE, out.width= "70%", fig.align="center"}
x <- seq(0,10,1)
...
```{r binom_distribution, warning = FALSE, message=FALSE, out.width= "70%", fig.align="center"}
...
```{r neg_binom_distribution, warning = FALSE, message=FALSE, out.width= "70%", fig.align="center"}
...
```{r hyper_distribution, warning = FALSE, message=FALSE, out.width= "70%", fig.align="center"}
...
```{r poisson_distribution, warning = FALSE, message=FALSE, out.width= "70%", fig.align="center"}
...
การกระจายตัวแบบ Poisson เป็นการกระจายตัวแบบพื้นฐานในการนับจำนวน gene ที่เกิดขึ้นจาก RNA sequencing profile
