...
สำหรับสัญลักษณ์ทางคณิตศาสตร์สามารถปรับได้โดยใช้คำสั่ง `bquote()`
...
| Syntax                      | Meaning                                         |
|---------------------------|---------------------------------------------|
| `"Text" ~ quote() ~ "Text"` | ตัวอักษรปกติ \~ Mathematic expression \~ ตัวอักษรปกติ |
| `x %+-% y`                  | x บวก หรือ ลบ y                                  |
| `x %/% y`                   | x หาร y                                         |
| `x[i]`                      | x ห้อยด้วย i (Subscript)                          |
| `x^i`                       | x ยกกำลัง i (Superscript)                        |
| `x ~~ y`                    | x เว้นวรรค y (ใน Mathematic expression เดียวกัน)   |
...
นอกจากนั้น ท่านยังสามารถ Transform ข้อมูลเป็นรูปแบบอื่นๆ ได้ด้วย
...
`ggplot2` นั้นมีชุดของสีเตรียมไว้ให้ส่วนหนึ่งแล้วสำหรับการสร้างกราฟ โดยใช้ `scale_color_brewer()`
...
และยังมีสีเพิ่มเติมสำหรับการวาดกราฟที่ใช้บ่อยใน Journal ต่างๆ ใน Package `ggsci` รายละเียดเพิ่มเติมที่ <https://nanx.me/ggsci/>
...
ในส่วนของสีที่เป็นพื้นที่ จะใช้ `scale_fill_xxx` ซึ่งมีลักษณะการใช้ในทางเดียวกัน
