...
[Limma](https://bioconductor.org/packages/release/bioc/html/limma.html) (Linear Model for Microarray Data) [@R-limma] เป็นหนึ่งใน `bioconductor mapackage` ที่นิยมใช้อย่างแพร่หลายในการศึกษา ความแตกต่างของการแสดงออกของยีนระหว่างกลุ่มสองกลุ่ม (Differential gene expression; DGE) ในงานทดลอง Microarray
