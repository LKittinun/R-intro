...
```{r same_dist_plot, echo = FALSE, out.width="70%", fig.align="center"}
...
```{r very_diff_dist, echo = FALSE, out.width="70%", fig.align="center", warning=FALSE}
...
```{r true20, echo = FALSE, out.width="70%", fig.align="center", warning=FALSE}
