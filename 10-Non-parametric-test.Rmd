...
Non-parametric test คือ การวิเคราะห์ทางสถิติที่เรา**ไม่**ทราบลักษณะการกระจายตัวของข้อมูลอย่างชัดเจน ข้อดีคือมีความยืดหยุ่นกว่า แต่มีความแม่นยำน้อยกว่า
...
จะเห็นว่าความแตกต่างระหว่าง observed และ expected นั้น อยู่ในพิสัยของของ \$H\_{0}\$
...
จะเห็นว่า ถ้าเป็นลูกเต๋าถ่วงน้ำหนัก เมื่อวิเคราะห์ chi-square ตามการกระจายตัวของลูกเต๋าทั่วไป จะแตกต่างอย่างมีนัยสำคัญ แต่ถ้าใช้การกระจายตัวเดียวกับลูกเต๋าถ่วงน้ำหนัก จะไม่แตกต่าง
...
ลักษณะการใช้คล้าย `t.test(…, paired = FALSE)` สำหรับ non-normal distribution
...
ลักษณะการใช้คล้าย `t.test(…, paired = TRUE)` สำหรับ non-normal distribution
